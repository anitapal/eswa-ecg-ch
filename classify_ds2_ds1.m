...
function classify_ds2_ds1(featureSet, classifier, type)
...
s = char(featureSet);
fileNamed = ['results\',s,'_',classifier,'_ds2_ds1_results.tex'];
...
DS2 = {'101';'106';'108';'109';'112';'114';'115';'116';'118';'119';'122';'124';'201';'203';'205';'207';'208';'209';'215';'220';'223';'230'};   
...
if(strcmp(classifier,'LD'))
    ...
    if(strcmp(featureSet,'2004Chazal'))
        cm1 = ld_Classifier_chazal(fs_3,fs_7,target);
    else
 ...
 % Calcula estatíSticas
   ...
   t=0;
    ...
    fprintf(arq,'%6d & %6.2f & %6.2f & %6.2f & %6.2f & %6.2f & %6.2f & %6.2f & %6.2f & %6.2f & %6.2f & %6.2f \\\\ \n',...
        str2double(DS2(k)), 100*acc_num/acc_den, sensitivityN, sensitivitySVEB,sensitivityVEB, sensitivityF, sensitivityQ,...
        specificityN, specificitySVEB,specificityVEB, specificityF, specificityQ);         
    fprintf(arq,'\n');
    
   fprintf('\n');
    
   fprintf('Registro=%6.0f | Acc=%6.2f |', str2double(DS2(k)), 100*acc_num/acc_den);
