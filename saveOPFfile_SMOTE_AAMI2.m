...
%
function [p1d p1t p2d p2t] = saveOPFfile_SMOTE_AAMI2(featureSet)
...
if smote_S_V == 1
    opf_folder_train = ['.\OPF\' featureSet '\DS1_smote_aami2.txt'];
else
    opf_folder_train = ['.\OPF\' featureSet '\DS1_aami2.txt'];
end
...
opf_folder_test = ['.\OPF\' featureSet '\DS2_aami2.txt'];
