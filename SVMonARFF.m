%% Demo de uso do código para classificação com SVM e ARFF (WEKA format)
% Autor: Eduardo Luz
%
% ** As matrizes nos arquivos .arff (trainMatrix e testMatrix) estão organizados por linha. 
...
%trainMatrix = ARFFtoMAT('.\weka\2007Yu_FS9__DS1_SMOTE.arff');
%testMatrix = ARFFtoMAT('.\weka\2007Yu_FS9__DS2.arff');

trainMatrix = ARFFtoMAT('.\weka\VCG_n_2_tq_03_128_128_A1_D1_RR_QRSrel_autocorr_FS12__DS1_SMOTE_k_3.arff');
testMatrix = ARFFtoMAT('.\weka\VCG_n_2_tq_03_128_128_A1_D1_RR_QRSrel_autocorr_FS12__DS2.arff');

% * ATENÇÃO : As características JÁ estão normalizadas!!! 
...
str = sprintf('-w1 1 -w2 1 -w3 1 -w4 1 -c %d -t 2 -g %f -d 4',C,gamma);
